            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextField(
                    cursorColor: Color.fromARGB(255, 113, 113, 122),
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: GestureDetector(
                          onTap: (){
                            _viewModel.filterData(_searchController.text.toString());
                          },
                      ...
                      border: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: Color.fromARGB(255, 215, 215, 235), width: 1.0),
                          borderRadius: BorderRadius.all(Radius.circular(10.0))),
                      focusedBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: Color.fromARGB(255, 215, 215, 235),
                              width: 1.0),
                          borderRadius:
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                      ...
                      ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            padding: EdgeInsets.all(
                                16), // Optional: padding around the icon
                          ),
                          onPressed: () {
                  ...
                  Text("Here are the details of following employee.",
                      style: TextStyle(
                          fontWeight: FontWeight.w400,
                          fontSize: 12.96,
                          color: Color.fromARGB(255, 113, 113, 122))),
                  SizedBox(
                    height: 5,
                  ),
