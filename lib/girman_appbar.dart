...
PreferredSizeWidget? GirmanAppbar(BuildContext context, {bool displayMenu = false}) {
  return AppBar(
      toolbarHeight: 70,
                      ...
                      PopupMenuItem<AppBarMenu>(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              border: Border(bottom: BorderSide(color: Colors.blueAccent, width: 2)) // Blue line when selected,
                            ),
                      ...
                      case AppBarMenu.WEBSITE:
                        {
                          await Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => WebviewScreen.createInstance(
